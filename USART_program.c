...
//Mode Selection
	...
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UMSEL);
...
//Parity Mode Selection
	...
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UPM0);
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UPM1);
...
//Stop Bits Selection
	...
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_USBS);
...
//Character size : 8 bits
	...
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UCSZ0);
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UCSZ1);
...
//Clock Polarity Selection (Synchronous mode only)
	...
	CLEAR_BIT(Local_u8UCSRCValue, UCSRC_UCPOL);
...
#error "Wrong double transmission speed configuration"
	...
	CLEAR_BIT(Local_u8UBBRHValue, UBRRH_URSEL);
